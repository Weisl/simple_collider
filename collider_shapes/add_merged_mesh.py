...
class OBJECT_OT_add_merged_mesh(OBJECT_OT_add_bounding_object, Operator):
    """Create a new bounding box object"""
    bl_idname = "mesh.add_merged_mesh"
    bl_label = "Merge Mesh"
    ...
    def invoke(self, context, event):
        ...
        self.my_use_modifier_stack = True
        self.keep_original_material = True
        self.keep_original_name = True
        self.shape = "mesh_shape"
        self.creation_mode_idx = self.creation_mode.index("SELECTION")
    ...
    def execute(self, context):
        ...
        super().print_generation_time("Merge Meshes", elapsed_time)
        self.report({'INFO'}, f"Merge Meshes: {float(elapsed_time)}")
